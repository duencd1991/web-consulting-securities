    ...
    const columns = [
      {
        ...
        accessor: 'name',
        Cell: props => <div className='table-center-element'><div className='table-center-time'>Người đăng ký:</div>
          {props.value}
        </div>
      },
      {
        ...
        maxWidth: 100,
        Cell: props => <div className='table-center-element'><div className='table-center-time'>Số điện thoại:</div>
          {props.value}
        </div>
      },
      {
        ...
        accessor: 'email',
        maxWidth: 200,
        Cell: props => <div className='table-center-element'><div className='table-center-time'>Email:</div>
          {props.value}
        </div>
      },
      {
        ...
        accessor: 'courseName',
        maxWidth: 200,
        Cell: props => <div className='table-center-element'><div className='table-center-time'>Tên khóa học:</div>
          {props.value}
        </div>
      },
      {
      ...
      },
      {
        ...
        accessor: 'createDate',
        maxWidth: 200,
        Cell: props => <div className='table-center-element'><div className='table-center-time'>Ngày đăng ký:</div>
          {props.value}
        </div>
      },
      {
...
export default connect(mapStateToProps, mapDispatchToProps)(ListRegisterCourse)