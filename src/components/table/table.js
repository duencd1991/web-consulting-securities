        ...
        <div className="d-flex flex-row-reverse">
          ...
          <div className="form-group sort-by">
            <div className="dropdown">
              ...
              <div
                className="dropdown-menu dropdown-menu-right select-row"
                aria-labelledby="dropdownRows"
              >
                <button
                  className="dropdown-item"
                  onClick={e => props.onChangePageSize(5)}
                >{`5 hàng`}</button>
                <button
                  className="dropdown-item"
                  onClick={e => props.onChangePageSize(10)}
                >{`10 hàng`}</button>
                <button
                  className="dropdown-item"
                  onClick={e => props.onChangePageSize(15)}
                >{`15 hàng`}</button>
                <button
                  className="dropdown-item"
                  onClick={e => props.onChangePageSize(20)}
                >{`20 hàng`}</button>
              </div>
            </div>
          </div>
