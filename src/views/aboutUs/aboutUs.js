      ...
      <Layout>
        <div className='about-us-page'>
          ...
          <div className='team-layout'>
            ...
            <hr />
            <div className='team-des'>Đội ngũ giảng viên của MBS tập hợp những chuyên gia hàng đầu trên thị trường chứng khoán với kho kiến thức sâu rộng cùng kinh nghiệm giao dịch lâu năm</div>
            <div className='team-special'>CHUYÊN GIA TƯ VẤN</div>
            <Slider {...settings}>
              {
                listTeachers.map((item, index) => {
                  return <div key={index} className='mem-item'>
                    <img alt={`ic-${index}`} src={item.img ? item.img : icNoImg}/>
          ...
          <div className='layout-contact'>
            ...
            <hr />
            <div className='contact-des'>Hãy liên hệ với chúng tôi để biết thêm chi tiết !</div>
